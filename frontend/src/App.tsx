...
const LEFT_DEMO_CARD: SideDemoCard = {
  title: "Requests Received",
  name: "Arjun Singh",
  subtitle: "Backend Developer • Rank 81",
  note: "Hey, would love to team up for the upcoming API-heavy sprint.",
  chips: ["Pending", "Node.js", "MongoDB"]
};

const RIGHT_DEMO_CARD: SideDemoCard = {
  title: "Your Friends",
  name: "Riya Sharma",
  subtitle: "UI/UX Designer • Rank 87",
  note: "Recently active and available for product + design collaborations.",
  chips: ["Online", "Figma", "Design Systems"]
};
    ...
    <>
      ...
      <div id="app" className="visible">
        ...
        <div className={`page ${page === "dashboard" ? "active" : ""}`}>
          ...
          <div className="friend-deck-layout">
            <div className="friend-side-card friend-side-card-left" aria-hidden="true">
              <div className="friend-side-title">{LEFT_DEMO_CARD.title}</div>
              <div className="friend-side-name">{LEFT_DEMO_CARD.name}</div>
              <div className="friend-side-sub">{LEFT_DEMO_CARD.subtitle}</div>
              <div className="friend-side-note">{LEFT_DEMO_CARD.note}</div>
              <div className="friend-side-chip-row">
                {LEFT_DEMO_CARD.chips.map((chip) => (
                  <span className="deck-skill" key={`left-chip-${chip}`}>{chip}</span>
                ))}
              </div>
            </div>

            <div className="teammate-deck-wrap friend-deck-center">
            ...
            <div className="friend-side-card friend-side-card-right" aria-hidden="true">
              <div className="friend-side-title">{RIGHT_DEMO_CARD.title}</div>
              <div className="friend-side-name">{RIGHT_DEMO_CARD.name}</div>
              <div className="friend-side-sub">{RIGHT_DEMO_CARD.subtitle}</div>
              <div className="friend-side-note">{RIGHT_DEMO_CARD.note}</div>
              <div className="friend-side-chip-row">
                {RIGHT_DEMO_CARD.chips.map((chip) => (
                  <span className="deck-skill" key={`right-chip-${chip}`}>{chip}</span>
                ))}
              </div>
            </div>
          </div>
